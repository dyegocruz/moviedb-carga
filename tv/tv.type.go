...
type Episode struct {
	...
	Localizations    []common.LocalizationCommon `json:"localizations" bson:"localizations"`
...
type Season struct {
	...
	Episodes      []Episode                   `json:"episodes,omitempty" bson:"-"`
}
...
type Serie struct {
	...
	PosterPath          string                       `json:"poster_path" bson:"-"`
	...
	AlternativeTitles   AlternativeTitlesTv          `json:"alternative_titles" bson:"-"`
	AlternativeTitlesDb []common.AlternativeTitle    `json:"alternative_titles_db" bson:"alternative_titles_db"`
}

type AlternativeTitlesTv struct {
	Results []common.AlternativeTitle `json:"results" bson:"results"`
}
